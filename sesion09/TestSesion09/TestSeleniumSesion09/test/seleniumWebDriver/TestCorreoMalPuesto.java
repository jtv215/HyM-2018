...
public class TestCorreoMalPuesto {
  ...
  @Test
  public void testCorreoMalPuesto() throws Exception {
    driver.get("http://sesion09-hmis18-vm4.eastus.cloudapp.azure.com/registro.php");
    driver.findElement(By.id("username")).click();
    driver.findElement(By.id("username")).clear();
    driver.findElement(By.id("username")).sendKeys("lola");
    driver.findElement(By.id("email")).clear();
    driver.findElement(By.id("email")).sendKeys("lola");
