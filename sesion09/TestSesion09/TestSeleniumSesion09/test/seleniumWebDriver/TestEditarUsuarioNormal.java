...
public class TestEditarUsuarioNormal {
  ...
  @Test
  public void testEditarUsuarioNormal() throws Exception {
    driver.get("http://sesion09-hmis18-vm4.eastus.cloudapp.azure.com/login.php");
    driver.findElement(By.linkText("LOGIN")).click();
    driver.findElement(By.id("username")).click();
    driver.findElement(By.id("username")).clear();
    driver.findElement(By.id("username")).sendKeys("carmen");
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("123456");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    driver.findElement(By.id("username")).click();
    driver.findElement(By.id("username")).clear();
    driver.findElement(By.id("username")).sendKeys("carmenEsther");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
  }
