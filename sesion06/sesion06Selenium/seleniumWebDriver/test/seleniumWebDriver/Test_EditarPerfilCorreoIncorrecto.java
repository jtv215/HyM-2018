...
public class Test_EditarPerfilCorreoIncorrecto {
  ...
  @Test
  public void testEditarPerfilCorreoIncorrecto() throws Exception {
    ...
    driver.findElement(By.id("Email")).clear();
    driver.findElement(By.id("Email")).sendKeys("jeffersonmax90@gmail.");
