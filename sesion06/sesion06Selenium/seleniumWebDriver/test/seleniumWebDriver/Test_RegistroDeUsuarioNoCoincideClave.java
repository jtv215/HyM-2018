...
public class Test_RegistroDeUsuarioNoCoincideClave {
  ...
  @Test
  public void testRegistroDeUsuarioNoCoincideClave() throws Exception {
    ...
    driver.findElement(By.id("Password")).sendKeys("hola1232456");
    driver.findElement(By.xpath("//form[@action='/Account/Register']")).click();
    driver.findElement(By.id("ConfirmPassword")).click();
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("hola123456");
  }
