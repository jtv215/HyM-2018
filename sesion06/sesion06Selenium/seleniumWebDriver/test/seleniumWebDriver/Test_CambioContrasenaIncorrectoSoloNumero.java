...
public class Test_CambioContrasenaIncorrectoSoloNumero {
  ...
  @Test
  public void testCambioContrasenaIncorrectoSoloNumero() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("555555");
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("555555");
