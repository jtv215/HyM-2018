...
public class Test_CambiarContraseAOk {
  ...
  @Test
  public void testCambiarContraseAOk() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("HolaMundo1!");
    driver.findElement(By.id("ConfirmPassword")).click();
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("HolaMundo1!");
