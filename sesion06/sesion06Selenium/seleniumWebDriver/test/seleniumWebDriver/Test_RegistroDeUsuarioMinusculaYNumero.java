...
public class Test_RegistroDeUsuarioMinusculaYNumero {
  ...
  @Test
  public void testRegistroDeUsuarioMinusculaYNumero() throws Exception {
    ...
    driver.findElement(By.id("ConfirmPassword")).sendKeys("hola123");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    driver.findElement(By.xpath("//form/div/ul")).click();
  }
