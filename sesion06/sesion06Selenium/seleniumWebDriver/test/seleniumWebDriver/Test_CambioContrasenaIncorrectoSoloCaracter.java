...
public class Test_CambioContrasenaIncorrectoSoloCaracter {
  ...
  @Test
  public void testCambioContrasenaIncorrectoSoloCaracter() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("______");
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("______");
