...
public class Test_CambioContrasenaIncorrectaMayuscula {
  ...
  @Test
  public void testCambioContrasenaIncorrectaMayuscula() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("AAAAAA");
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("AAAAAA");
