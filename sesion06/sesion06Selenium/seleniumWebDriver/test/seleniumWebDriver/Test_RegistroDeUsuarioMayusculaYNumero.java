...
public class Test_RegistroDeUsuarioMayusculaYNumero {
  ...
  @Test
  public void testRegistroDeUsuarioMayusculaYNumero() throws Exception {
    ...
    driver.findElement(By.id("ConfirmPassword")).sendKeys("HOLA1234");
