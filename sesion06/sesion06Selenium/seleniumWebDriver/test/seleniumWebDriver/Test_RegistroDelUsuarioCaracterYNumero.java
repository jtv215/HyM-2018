...
public class Test_RegistroDelUsuarioCaracterYNumero {
  ...
  @Test
  public void testRegistroDelUsuarioCaracterYNumero() throws Exception {
    ...
    driver.findElement(By.id("Password")).sendKeys("______5");
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("______5");
