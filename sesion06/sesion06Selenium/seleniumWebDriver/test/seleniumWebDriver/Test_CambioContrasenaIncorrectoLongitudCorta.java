...
public class Test_CambioContrasenaIncorrectoLongitudCorta {
  ...
  @Test
  public void testCambioContrasenaIncorrectoLongitudCorta() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("asd4");
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("asd4");
