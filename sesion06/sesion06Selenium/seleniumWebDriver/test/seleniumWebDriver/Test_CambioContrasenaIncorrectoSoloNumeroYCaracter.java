...
public class Test_CambioContrasenaIncorrectoSoloNumeroYCaracter {
  ...
  @Test
  public void testCambioContrasenaIncorrectoSoloNumeroYCaracter() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("55555_");
    driver.findElement(By.id("ConfirmPassword")).click();
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("55555_");
