...
public class Test_Test_RegistroDelUsuarioMinusculaNumeroCaracter {
  ...
  @Test
  public void testRegistroDelUsuarioMinusculaNumeroCaracter() throws Exception {
    ...
    driver.findElement(By.id("Password")).sendKeys("aaaaaa5_");
    driver.findElement(By.id("ConfirmPassword")).click();
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("aaaaaa5_");
