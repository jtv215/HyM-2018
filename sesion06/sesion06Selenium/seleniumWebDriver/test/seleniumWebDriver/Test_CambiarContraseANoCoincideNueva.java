...
public class Test_CambiarContraseANoCoincideNueva {
  ...
  @Test
  public void testCambiarContraseANoCoincideNueva() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("CarmenFernadez789");
    driver.findElement(By.id("ConfirmPassword")).click();
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("CarmenFernandez789");
  }
