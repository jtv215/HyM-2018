...
public class Test_RegistroDelUsuarioCaracter {
  ...
  @Test
  public void testRegistroDelUsuarioCaracter() throws Exception {
    ...
    driver.findElement(By.id("Password")).sendKeys("______");
