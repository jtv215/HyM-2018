...
public class Test_CambiarContraseAFaltaCaracterNoAlfanumerico {
  ...
  @Test
  public void testCambiarContraseAFaltaCaracterNoAlfanumerico() throws Exception {
    ...
    driver.findElement(By.id("NewPassword")).sendKeys("25F2018th");
    driver.findElement(By.id("ConfirmPassword")).click();
    driver.findElement(By.id("ConfirmPassword")).clear();
    driver.findElement(By.id("ConfirmPassword")).sendKeys("25F2018th");
