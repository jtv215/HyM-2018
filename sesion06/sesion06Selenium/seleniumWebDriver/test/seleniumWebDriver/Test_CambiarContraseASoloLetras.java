...
public class Test_CambiarContraseASoloLetras {
  ...
  @Test
  public void testCambiarContraseASoloLetras() throws Exception {
    ...
    driver.findElement(By.id("OldPassword")).sendKeys("HolaMundo1!");
